...
CHAINBASE_SET_INDEX_TYPE( dncio::transaction_history_object, dncio::transaction_history_multi_index )

FC_REFLECT( dncio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
