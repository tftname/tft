...
namespace std {
   ...
   template<>
   struct hash<dncio::chain::account_name>
   {
    size_t operator()( const dncio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( dncio::account_transaction_history_object, dncio::account_transaction_history_multi_index )

FC_REFLECT( dncio::account_transaction_history_object, (name)(transaction_id) )
