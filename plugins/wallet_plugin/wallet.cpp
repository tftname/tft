 ...
 */
#include <dncio/wallet_plugin/wallet.hpp>
...
namespace dncio { namespace wallet {
...
public:
   ...
   bool import_key(string wif_key)
   {
      ...
      dncio::chain::public_key_type wif_pub_key = priv.get_public_key();
...
} dnc_RETHROW_EXCEPTIONS(chain::wallet_invalid_password_exception,
