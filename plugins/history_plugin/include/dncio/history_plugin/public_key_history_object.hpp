...
CHAINBASE_SET_INDEX_TYPE( dncio::public_key_history_object, dncio::public_key_history_multi_index )

FC_REFLECT( dncio::public_key_history_object, (public_key)(name)(permission) )
