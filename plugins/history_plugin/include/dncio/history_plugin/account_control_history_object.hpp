...
CHAINBASE_SET_INDEX_TYPE( dncio::account_control_history_object, dncio::account_control_history_multi_index )

FC_REFLECT( dncio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
