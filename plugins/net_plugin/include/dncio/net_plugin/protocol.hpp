...
FC_REFLECT( dncio::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( dncio::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( dncio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( dncio::go_away_message, (reason)(node_id) )
FC_REFLECT( dncio::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( dncio::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( dncio::request_message, (req_trx)(req_blocks) )
FC_REFLECT( dncio::sync_request_message, (start_block)(end_block) )
