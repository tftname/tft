...
#include <dncio/bnet_plugin/bnet_plugin.hpp>
...
using dncio::public_key_type;
using dncio::chain_id_type;
using dncio::block_id_type;
using dncio::block_timestamp_type;
using std::string;
using dncio::sha256;
using dncio::signed_block_ptr;
using dncio::packed_transaction_ptr;
using std::vector;
