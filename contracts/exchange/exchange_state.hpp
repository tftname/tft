...
namespace dncio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         dncio_assert( interest_shares >= 0, "underflow" );
         dncio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      dncLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         dncLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      dncLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef dncio::multi_index<N(markets), exchange_state> markets;
