...
namespace dncio {
   ...
   class optional {
      public:
         ...
         T&       operator*()      { dncio_assert(_valid, "dereference of empty optional"); return ref(); }
         const T& operator*()const { dncio_assert(_valid, "dereference of empty optional"); return ref(); }

         T*       operator->()
         {
            dncio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         friend inline dncio::datastream<Stream>& operator>> (dncio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         template<typename Stream>
         friend inline dncio::datastream<Stream>& operator<< (dncio::datastream<Stream>& ds, const optional& op)
         {
