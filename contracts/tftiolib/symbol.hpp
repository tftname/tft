#pragma once
#include <dnciolib/core_symbol.hpp>
...
namespace dncio {
   ...
   #define S(P,X) ::dncio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      dncLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
      ...
      dncLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
