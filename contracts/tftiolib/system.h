...
extern "C" {
    ...
    */
   void  dncio_assert( uint32_t test, const char* msg );
    ...
    */
   void  dncio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  dncio_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  dncio_exit( int32_t code );
