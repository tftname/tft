...
namespace dnciosystem {
   ...
   struct permission_level_weight {
      ...
      dncLIB_SERIALIZE( permission_level_weight, (permission)(weight) )
   };
   ...
   struct key_weight {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      dncLIB_SERIALIZE( key_weight, (key)(weight) )
   };
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      dncLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      dncio::optional<dncio::producer_schedule> new_producers;

      // explicit serialization macro is not necessary, used here only to improve compilation time
      dncLIB_SERIALIZE(block_header, (timestamp)(producer)(confirmed)(previous)(transaction_mroot)(action_mroot)
    ...
    */
   class native : public dncio::contract {
      public:

         using dncio::contract::contract;
