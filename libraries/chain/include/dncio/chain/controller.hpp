...
FC_REFLECT( dncio::chain::tmp_transfer, (from)(to)(quantity)(memo) )
FC_REFLECT( dncio::chain::tmp_issue, (to)(quantity)(memo) )
FC_REFLECT( dncio::chain::tmp_vote, (voter)(bpname)(change) )
FC_REFLECT( dncio::chain::tmp_claim, (voter)(bpname) )
FC_REFLECT( dncio::chain::tmp_unfreeze, (voter)(bpname))

FC_REFLECT( dncio::chain::controller::config,
            (actor_whitelist)
            (actor_blacklist)
            (contract_whitelist)
            (contract_blacklist)
