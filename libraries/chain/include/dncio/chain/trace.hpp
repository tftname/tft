...
FC_REFLECT( dncio::chain::base_action_trace,
                    (receipt)(act)(elapsed)(cpu_usage)(console)(total_cpu_usage)(trx_id) )

FC_REFLECT_DERIVED( dncio::chain::action_trace,
                    (dncio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( dncio::chain::transaction_trace, (id)(receipt)(elapsed)(net_usage)(scheduled)
                                             (action_traces)(failed_dtrx_trace)(except) )
FC_REFLECT( dncio::chain::block_trace, (elapsed)(billed_cpu_usage_us)(trx_traces) )
