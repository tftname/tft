...
namespace dncio { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against dncIO specific constraints
      ...
      private:
         ...
         friend class dncio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( dncio::chain::wasm_interface::vm_type, (wavm)(binaryen) )
