...
struct genesis_state {
   ...
   static const string dncio_root_key;
...
FC_REFLECT(dncio::chain::account_tuple, (key)(asset)(name))
FC_REFLECT(dncio::chain::producer_tuple, (name)(bpkey)(commission_rate)(url))
FC_REFLECT(dncio::chain::genesis_state,
