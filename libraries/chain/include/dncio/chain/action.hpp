...
namespace dncio { namespace chain {
    ...
    *  In the context of dncio, every action is dispatched to the handler defined
...
FC_REFLECT( dncio::chain::permission_level, (actor)(permission) )
FC_REFLECT( dncio::chain::action, (account)(name)(authorization)(data) )
