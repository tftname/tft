...
FC_REFLECT(dncio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(dncio::chain::key_weight, (key)(weight) )
FC_REFLECT(dncio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(dncio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(dncio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
