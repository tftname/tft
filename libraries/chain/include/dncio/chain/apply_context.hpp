...
//               context.require_write_lock( table_obj.scope );
   ...
   public:
      ...
      void setcode_require_authorization(const account_name& account);
...
//FC_REFLECT(dncio::chain::apply_context::apply_results, (applied_actions)(deferred_transaction_requests)(deferred_transactions_count))
