...
CHAINBASE_SET_INDEX_TYPE(dncio::chain::permission_link_object, dncio::chain::permission_link_index)

FC_REFLECT(dncio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
