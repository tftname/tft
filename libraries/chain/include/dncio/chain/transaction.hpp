...
#include <dncio/chain/action.hpp>
...
FC_REFLECT( dncio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( dncio::chain::transaction, (dncio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions)(fee) )
FC_REFLECT_DERIVED( dncio::chain::signed_transaction, (dncio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( dncio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( dncio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( dncio::chain::deferred_transaction, (dncio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( dncio::chain::deferred_reference, (sender)(sender_id) )
