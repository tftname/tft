...
using action_name    = dncio::chain::action_name;
...
FC_REFLECT( dncio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( dncio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( dncio::chain::setabi                           , (account)(abi) )
FC_REFLECT( dncio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( dncio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( dncio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( dncio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( dncio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( dncio::chain::onerror                          , (sender_id)(sent_trx) )
