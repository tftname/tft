...
#include <dncio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dncio::chain::global_property_object, dncio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::dynamic_global_property_object,
                         dncio::chain::dynamic_global_property_multi_index)

FC_REFLECT(dncio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(dncio::chain::global_property_object,
