...
FC_REFLECT( dncio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( dncio::chain::field_def                        , (name)(type) )
FC_REFLECT( dncio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( dncio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( dncio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( dncio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( dncio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( dncio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
