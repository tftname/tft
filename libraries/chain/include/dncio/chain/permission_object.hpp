...
CHAINBASE_SET_INDEX_TYPE(dncio::chain::permission_object, dncio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::permission_usage_object, dncio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<dncio::chain::permission_object>, (_id))
FC_REFLECT(dncio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<dncio::chain::permission_usage_object>, (_id))
FC_REFLECT(dncio::chain::permission_usage_object, (id)(last_used))
