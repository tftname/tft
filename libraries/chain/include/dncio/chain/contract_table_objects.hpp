...
#include <dncio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dncio::chain::table_id_object, dncio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::key_value_object, dncio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(dncio::chain::index64_object, dncio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::index128_object, dncio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::index256_object, dncio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::index_double_object, dncio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(dncio::chain::index_long_double_object, dncio::chain::index_long_double_index)

FC_REFLECT(dncio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(dncio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
